...
{
public:
    bool was_created = false; // была ли создана текстура для экрана после поражения в игре
    ...
    SDL_Texture* texture_game = nullptr; // текстура для экрана во время игры
...
public:
    ...
    int y; // координата y верхнего левого угла пунтк меню
