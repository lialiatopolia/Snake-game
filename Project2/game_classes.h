...
public:
    ...
    int i_y_for_tail; // координата y хвоста змейки; используется, когда змейка съедает 
    int food_eaten;        // Количество съеденных блоков еды
    float speed_factor;    // Множитель скорости змейки
